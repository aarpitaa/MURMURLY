...
async function start_server(BRIDGE_HOST, HOST, PORT) {
    ...
    let [server, client] = await tunnel.createTunnel(tunnelOptions, serverOptions,
sshOptions, forwardOptions);
...
start_server('login06.cselabs.umn.edu', 'cse-mysql-classes-01.cse.umn.edu', 3306);
